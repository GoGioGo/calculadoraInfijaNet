Public Class Form1
    ...
    Private Sub btnraiz_Click(sender As Object, e As EventArgs)
        Try
            If txtpantalla.Text <> "" Then
                memoria1 = Val(txtpantalla.Text)
                signo = "raiz"
    ...
    Private Sub btnporcentaje_Click(sender As Object, e As EventArgs)
        Try
            If txtpantalla.Text <> "" Then
                memoria1 = Val(txtpantalla.Text)
                signo = "%"
    ...
    Private Sub btnmasmenos_Click(sender As Object, e As EventArgs)
        Try
            If txtpantalla.Text <> "" Then
                txtpantalla.Text = txtpantalla.Text * (-1)
            End If
    ...
    Private Sub btninversa_Click(sender As Object, e As EventArgs)
        Try
            If txtpantalla.Text <> "" Then
